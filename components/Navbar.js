        ...
        <header className="text-gray-600 body-font sticky top-0 bg-white z-10 shadow-sm">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                    ...
                    <span className="ml-3 text-xl">Esight</span>
                </a>
                ...
                <button className="inline-flex items-center border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 cursor-pointer rounded text-base mt-4 md:mt-0">
